    ...
    <footer class="footer w">
        <div class="flex">
            ...
            <div class="footer__col">
                ...
                <a href="/metahuman" class="footer__col__link">
                    Metahuman
                </a>
                <a href="/kontakt" class="footer__col__link">
                    Kontakt
                </a>
            </div>
            <div class="footer__col">
                ...
                <a href="/regulamin" class="footer__col__link">
                    Regulamin
                </a>
...
function metahuman_after_single_product() {
    ?>
    <section class="w section">
        <h2 class="section__header">
            Polecane produkty
        </h2>
        <div class="flex recomendations">
...
add_action('woocommerce_after_single_product', 'metahuman_after_single_product');

function metahuman_before_add_to_cart_form() {
    global $product;
    ...
    <div class="productDetails">
		<?php
		echo get_field('dodatkowe_informacje');
		?>
    </div>
...
add_action('woocommerce_before_add_to_cart_form', 'metahuman_before_add_to_cart_form');

function metahuman_before_single_product_summary() {
    global $product;
