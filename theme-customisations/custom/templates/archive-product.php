        ...
        if ( is_search() ) {
            ...
            <section class="w section">
                ...
                <div class="filters">
                    ...
                    <a class="<?php if($sort == 0) echo 'filters__sort filters__sort--selected'; else echo 'filters__sort'; ?>" href="/sklep?sort=new">
                        Najnowsze
                    </a>
                    <a class="<?php if($sort == 1) echo 'filters__sort filters__sort--selected'; else echo 'filters__sort'; ?>" href="/sklep?sort=price-asc">
                        Cena (od najniższej)
                    </a>
                    <a class="<?php if($sort == 2) echo 'filters__sort filters__sort--selected'; else echo 'filters__sort'; ?>" href="/sklep?sort=price-desc">
                        Cena (od najwyższej)
                    </a>
                    <a class="<?php if($sort == 3) echo 'filters__sort filters__sort--selected'; else echo 'filters__sort'; ?>" href="/sklep?sort=by-name">
                        Lista A-Z
                    </a>
                </div>
                <div class="flex productsWrapper">
